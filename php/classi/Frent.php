...
class Frent {
    ...
    public function ricercaAnnunci($citta, $numOspiti, $dataInizio, $dataFine): array {
        ...
        $lista_annunci = $this->b_instance->queryProcedure("ricerca_annunci(\'$citta\', $numOspiti, \'$dataInizio\', \'$dataFine\')");
    ...
    public function registrazione($nome, $cognome, $username, $mail, $password, $dataNascita, $imgProfilo, $numTelefono): boolean {
        $this->db_instance->connect();
        $risultato = $this->db_instance->queryFunction("registrazione(\'$nome\', \'$cognome\', \'$username\', \'$mail\', \'$password\', \'$dataNascita\', \'$imgProfilo\', \'$numTelefono\')");
    ...
    public function login($username_or_mail, $password): Utente {
        $this->db_instance->connect();
        $utente = $this->db_instance->queryProcedure("login(\'$username_or_mail\', \'$password\')");
