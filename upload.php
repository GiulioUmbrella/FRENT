...
/*
$target_dir = "uploads/"; // cartella in cui caricare i file
$target_file = $target_dir . basename($_FILES["fileToUpload"]["name"]); // path e nome completo del file da caricare sul server
$uploadOk = 1;
$imageFileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION)); // recupera l'estensione del file e la rende lowercase
