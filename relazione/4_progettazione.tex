...
Per impostare il layout delle pagine abbiamo cercato di utilizzare degli schemi quanto più semplici possibile. lPer aiutare la navigazione tutte le pagine riportano il breadcrumb con il percorso completo per arrivare alla pagina. In questo modo l'utente può ricostruire in maniera intuitiva il percorso che ha fatto. Per non confondere l'utente, nei menu con link alle pagine abbiamo evitato di inserire link circolari. 
Abbiamo utilizzato il layout a tre pannelli per due pagine: risultati ricerche e gestione annuncio
Risultati ricerche
In questo caso abbiamo conservato 
