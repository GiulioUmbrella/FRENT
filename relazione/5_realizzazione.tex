...
Quando un utente si registra al sito viene creata di deafult una cartella \textit{uploads/userID} con ID dell'utente dove verranno caricati tutti i file da lui aggiunti come immagini profilo (\textit{uploads/userID/imgProfiloID}) e anteprime degli annunci (\textit{uploads/userID/AnnuncioID_ANUNCIO}).
